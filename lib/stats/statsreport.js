...
class StatsReport {
   ...
   */
  constructor(peerConnectionId, statsResponse, prepareForInsights, networkQuality) {
    ...
    Object.defineProperties(this, {
      ...
      localAudioTrackStats: {
        value: statsResponse.localAudioTrackStats.map(report => new LocalAudioTrackStats(report.trackId, report, prepareForInsights, networkQuality)),
        enumerable: true
      },
      localVideoTrackStats: {
        value: statsResponse.localVideoTrackStats.map(report => new LocalVideoTrackStats(report.trackId, report, prepareForInsights, networkQuality)),
        enumerable: true
      },
