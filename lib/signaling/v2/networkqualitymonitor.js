...
function next(monitor) {
  ...
  const factories = pcs.map(pc => {
    ...
    console.log('maktodo: PeerConnectionReportFactory is created here.');
  ...
  // maktodo: report is generated here.
  // report schema is described here: https://code.hq.twilio.com/client/room-signaling-protocol/blob/master/schema/media/network_quality/client.yaml
