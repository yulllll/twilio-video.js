...
const { reconnectBackoffConfig, ICE_VERSION, RSP_VERSION } = require('../../util/constants');
...
function setupTransport(transport) {
  function createOrResetTwilioConnection() {
    ...
    // maktodo: transport (twilioConnection) gets created here.
